...
case  "$request"  in
		...
		if  (( ${webradio} == 1 )); then
			...
			echo "<body>"
			echo "<center>"
			echo "<a href='javascript:ajaxMedia(\"mplayeron\");'><img width='256' height='256' src='data:image/png;base64,$play'></a>"
			echo "<br>"
			echo "<br>"
			echo "<a href='javascript:ajaxMedia(\"mplayeroff\");'><img width='256' height='256' src='data:image/png;base64,$stop'></a>"
			echo "<br>"
			echo "<br>"
			echo "<a href='javascript:ajaxMedia(\"louder\");'><img width='256' height='256' src='data:image/png;base64,$louder'></a>"
			echo "<br>"
			echo "<br>"
			echo "<a href='javascript:ajaxMedia(\"quieter\");'><img width='256' height='256' src='data:image/png;base64,$quieter'></a>"
			echo "<br>"
			echo "<br>"
			echo "<a href='javascript:ajaxMedia(\"mute\");'><img width='256' height='256' src='data:image/png;base64,$mute'></a>"
			echo "</center>"
			echo "</body>"
			echo "</html>"
			exit 0
...
#		echo "<div id='VnstatiHolder'></div>"
		...
		if  (( ${webradio} == 1 )); then
			...
			echo "<center>"
			echo "<a href='javascript:ajaxMedia(\"mplayeron\");'><img src='data:image/png;base64,$play'></a>"
			echo "<a href='javascript:ajaxMedia(\"mplayeroff\");'><img src='data:image/png;base64,$stop'></a>"
			echo "<a href='javascript:ajaxMedia(\"louder\");'><img src='data:image/png;base64,$louder'></a>"
			echo "<a href='javascript:ajaxMedia(\"quieter\");'><img src='data:image/png;base64,$quieter'></a>"
			echo "<a href='javascript:ajaxMedia(\"mute\");'><img src='data:image/png;base64,$mute'></a>"
			echo "</center>"
			echo "</div>"
		fi
		echo "</center>"
